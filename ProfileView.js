  ...
  render() {
    return (
      ...
      >
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap' }} accessible={true} accessibilityHint="You can change your profile here. Swipe left to go to the previous element. Swipe right to go to the next element. Please continue to swipe right if you want to change the tab">
        ...
        <Text style={{ textAlignVertical: "center", fontWeight: "700", fontSize: 20 }} accessible={true} accessibilityLabel="Please specify your fitness goals"  accessibilityHint="Swipe right to navigate through each fitness goal">Fitness Goals</Text>
        <View style={styles.spaceSmall}></View>
        <View accessible={true} accessibilityLabel="What is your daily calories goal, in kcal?" accessibilityHint="Swipe right to edit">
        ...
        <TextInput style={styles.input}
          ...
          autoCapitalize="none" 
          accessible={true}
          accessibilityLabel="Your current daily goal is"
          accessibilityHint="Swipe right to navigate to the next goal. Please remember to swipe right to the end to save your changes."/>
        <View style={styles.spaceSmall}></View>
        <View>
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
          <Button color="#942a21" style={styles.buttonInline} accessible={true} accessibilityLabel="Double click to save changes to your Profile" title="Save Profile" onPress={() => this.handleSaveProfile()} />
          <View style={styles.spaceHorizontal} />
          <Button color="#a1635f" style={styles.buttonInline} accessible={true} accessibilityLabel="Double click to log out" title="Exit" onPress={() => this.backToLogin()} />
        </View>
        <View style={styles.space} />
      </ScrollView>
    );
